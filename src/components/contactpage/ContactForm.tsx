  ...
  return (
    ...
    >
      <motion.div variants={itemVariants} className="mb-8">
        <h2 className="text-4xl lg:text-5xl font-bold text-[#243061] dark:text-white mb-4">
          Connect With Our Team
        </h2>
        <p className="text-gray-600 dark:text-gray-400 text-lg">
          Stay connected with Newman Ministries International. Whether you{"'"}re visiting, seeking
          support, or reaching out for ministry-related inquiries, we{"'"}re here for you.{' '}
        </p>
      </motion.div>
                ...
                className={`w-full pl-12 pr-4 py-4 rounded-2xl border-2 transition-all duration-300 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400
                  ${
                    errors.name
                      ...
                      : 'border-gray-200 dark:border-gray-700 focus:border-[#fcb129]'
                  } focus:outline-none`}
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-4 rounded-2xl border-2 transition-all duration-300 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400
                  ${
                    errors.email
                      ? 'border-red-300 focus:border-red-500 focus:ring-red-200'
                      : 'border-gray-200 focus:border-[#fcb129]'
                  } focus:outline-none`}
            ...
            className={`w-full py-4 px-8 rounded-2xl font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-3 shadow-lg cursor-pointer
              ${
                isSubmitting
                  ...
                  : 'bg-[#243061] hover:from-purple-700 hover:to-[#243061] text-white'
              }`}
          >
            {isSubmitting ? (
              <>
