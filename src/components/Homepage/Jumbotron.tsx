      ...
      <div className="bg-[#1e254b] text-white py-4 overflow-hidden">
        <div className="whitespace-nowrap flex space-x-8 md:space-x-16 px-4 md:px-8">
          <Marquee className='flex gap-4'>
            <span className="text-sm md:text-lg font-semibold flex items-center">
            ...
            <span className="text-sm md:text-lg font-semibold flex items-center">Contact Us at: +254 707 019270 &nbsp; &nbsp; <GoNorthStar /> &nbsp; &nbsp;</span>
          </Marquee>
        </div>
      </div>
    </section>
