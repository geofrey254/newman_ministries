...
export default function Newsletter() {
  return (
    <section>
      <div className="bg-[url('/prayer.jpg')] bg-cover bg-center bg-fixed relative text-white h-[80vh] py-12 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        <form className="w-full max-w-md flex flex-col sm:flex-row gap-4 z-50 mt-8 bg-[#fffff6] px-4 py-2 rounded-full">
          <input
            type="email"
